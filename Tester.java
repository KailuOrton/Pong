...
final public class Tester extends Thread implements ActionListener, Runnable {
    DrawPanel drawPanel;
    JFrame old;
   // Thread thread1 = new Thread(new Tester());
    ...
    private int direction = 125; // starting coordinates for the rectangle
    ...
    private void moveIt() {
        while(true){
            ...
            if(oneY == 255 && oneX >= direction && oneX <= (direction + 50)){
                up = true;
                down = false;
                points++;
            }
